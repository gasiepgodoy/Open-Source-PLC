...
//557012/450068/2.49/14/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN74AHC08PW" (originalName "SN74AHC08PW")
	...
	(compDef "SN74AHC08PW" (originalName "SN74AHC08PW") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN74AHC08PW"))
		...
		(attr "Manufacturer_Part_Number" "SN74AHC08PW")
		(attr "Mouser Part Number" "595-SN74AHC08PW")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/SN74AHC08PW?qs=3pnr37ZAbK%252BIPRPPiAPWMg%3D%3D")
		(attr "Arrow Part Number" "SN74AHC08PW")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/sn74ahc08pw/texas-instruments")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "Quadruple 2-Input Positive-AND Gates")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/SN74AHC08")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "SN74AHC08PW.stp")

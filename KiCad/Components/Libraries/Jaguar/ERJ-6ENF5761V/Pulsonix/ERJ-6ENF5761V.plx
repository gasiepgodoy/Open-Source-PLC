...
(library Library_1
	...
	(patternDef "ERJ6EN_(0805)" (originalName "ERJ6EN_(0805)")
		...
		(layerContents (layerNumRef 18)
			(arc (pt -2.275, 0) (radius 0) (width 0.2))
		)
	...
	(compDef "ERJ-6ENF5761V" (originalName "ERJ-6ENF5761V") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		...
		(attr "<Hyperlink>" "http://industrial.panasonic.com/cdbs/www-data/pdf/RDA0000/AOA0000C304.pdf")
		(attr "<Component Height>" "0.55")
		(attr "<STEP Filename>" "ERJ-6ENF5761V.stp")

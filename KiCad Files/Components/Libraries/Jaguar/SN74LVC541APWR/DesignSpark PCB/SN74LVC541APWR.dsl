SamacSys ECAD Model
237654/450068/2.49/20/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN74LVC541APWR" (originalName "SN74LVC541APWR")
	...
	(compDef "SN74LVC541APWR" (originalName "SN74LVC541APWR") (compHeader (numPins 20) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "18" (pinName "Y1") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "17" (pinName "Y2") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "16" (pinName "Y3") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "15" (pinName "Y4") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "14" (pinName "Y5") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "Y6") (partNum 1) (symPinNum 18) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "12" (pinName "Y7") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "11" (pinName "Y8") (partNum 1) (symPinNum 20) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN74LVC541APWR"))
		...
		(attr "Manufacturer_Part_Number" "SN74LVC541APWR")
		(attr "Mouser Part Number" "595-SN74LVC541APWR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/SN74LVC541APWR?qs=DcvZ7Fltd5yUfWNWQTtNtQ%3D%3D")
		(attr "Arrow Part Number" "SN74LVC541APWR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/sn74lvc541apwr/texas-instruments?region=nac")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "SN74LVC541APWR, 8-Bit Buffer, Line Driver, LVC, 3-State Non-Inverting 1.65  3.6 V 20-Pin TSSOP")
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/SFDatasheet-6/sf-000126984.pdf")
		(attr "Height" "1.2 mm")
	)

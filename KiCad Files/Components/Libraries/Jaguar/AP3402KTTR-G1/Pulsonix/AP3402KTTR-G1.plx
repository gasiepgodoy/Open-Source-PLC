...
//282240/450068/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AP3402KTTR-G1" (originalName "AP3402KTTR-G1")
	...
	(compDef "AP3402KTTR-G1" (originalName "AP3402KTTR-G1") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "FB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP3402KTTR-G1"))
		...
		(attr "Manufacturer_Part_Number" "AP3402KTTR-G1")
		(attr "Mouser Part Number" "621-AP3402KTTR-G1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AP3402KTTR-G1?qs=LJyqx%252Bm7g4f%252B%2FVb1cFR9iQ%3D%3D")
		(attr "Arrow Part Number" "AP3402KTTR-G1")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ap3402kttr-g1/diodes-incorporated?region=nac")
		(attr "Description" "Switching Voltage Regulators 1.0MHz 2A Step Down DC-DC Buck 2A Output")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/DKDS-29/576309.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "AP3402KTTR-G1.stp")

...
(library Library_1
	...
	(patternDef "SHDRRA3W90P0X350_1X3_1110X920X" (originalName "SHDRRA3W90P0X350_1X3_1110X920X")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.35 1.5) (pt -2.35 11) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.35 11) (pt 9.25 11) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.25 11) (pt 9.25 1.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.25 1.5) (pt -2.35 1.5) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "2350514-3" (originalName "2350514-3") (compHeader (numPins 3) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.te.com/commerce/DocumentDelivery/DDEController?Action=showdoc&DocId=Customer+Drawing%7F2350514%7FA%7Fpdf%7FEnglish%7FENG_CD_2350514_A.pdf%7F2350514-3")
		(attr "<Component Height>" "6.91")
		(attr "<STEP Filename>" "2350514-3.stp")
		(attr "<STEP Offsets>" "X=3.45;Y=7.96;Z=3.41")
